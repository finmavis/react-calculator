...
class Calculator extends Component {
  ...
  getResult = () => {
    ...
    const beforeResult = this.state.register.concat(this.state.currentValue).join(' ');
    ...
    return (
      <div className="wrapper d-flex justify-content-center align-items-center">
        <div className="calculator-wrapper">
          <Display expression={this.state.expression} value={this.state.currentValue} />
            <div className="controls-history">
              <Button type="block" click={this.toggleHistoryHandler}><i className="fas fa-history"></i></Button>
            </div>
            { this.state.showHistory ? <History history={this.state.history} deleteHistory={this.deleteHistoryHandler} loadHistory={(i) => this.loadHistoryHandler(i)} /> : <Keypad click={(e) => this.clickHandler(e)} /> }
        </div>
      </div>
    );
  }
